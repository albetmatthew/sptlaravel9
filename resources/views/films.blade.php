        ...
        <div class="row">
            ...
            <div class="col-md-3 col-6 mb-4">
                ...
                <small class="text-muted">
                     <p class="text-center">Diupload oleh <a  href="/publisher/{{ $film->publisher->username }}" class="text-decoration-none">{{ $film->publisher->name }}</a></p>
                </small>
                    {{-- Deskripsi singkat film --}}
                      {{-- <p class="card-text">{{ $film->excerpt }}</p> --}}
                      <a href="/films/{{ $film->slug}}" class="btn bg-light  w-100">Sinopsis Film</a>
                    </div>
                  </div>
