            ...
            <div class="sidebar">
                ...
                <div class="sidebar-body">
                    <ul class="navigation-list">
                        ...
                        <li class="navigation-list-item {{ Request::is('/') ? 'active' : '' }}">
                ...
                <div class="container-fluid mx-auto">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-10">
                      ...
                      <form action="/dashboard/films/{{ $film->slug }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                         ...
                         <input type="hidden" name="oldImage" value="{{ $film->image }}">
                          @if($film->image)
                          <img src="{{ asset('storage/' . $film->image) }}" class="d-block img-preview img-fluid mb-3 col-sm-5">
                          @else
